            ...
            <br></br>
                <Row>
                    ...
                    <Col style={{ margin:'auto' }}>
                        <Card>
                        <Card.Header className="text-center text-white" style={{ backgroundColor:'#FF0000'}}>FGD</Card.Header>
                        <Card.Body>
                            <p style={{ color:'red' }}>{ this.state.message }</p>
                            <Form onSubmit={this.onSubmit}>
                                <Form.Group controlId="formBasicLink">
                                    <Form.Label>Metting Room Link</Form.Label>
                                    <Form.Control disabled as="textarea" rows="3" name="link" value="https://...." />
                                    {/* <Form.Text className="text-muted">
                                    We'll never share your email with anyone else.
                                    </Form.Text> */}
                                </Form.Group>

                                <Form.Group controlId="formBasicPresence">
                                    <Form.Label>Kode Presensi</Form.Label>
                                    <Form.Control type="text" name="presence" placeholder="Kode Presensi"  required />
                                </Form.Group>
